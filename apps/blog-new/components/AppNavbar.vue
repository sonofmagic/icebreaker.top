...
<template>
  <div class="flex justify-between max-w-2xl px-4 py-4 mx-auto sm:px-8">
    ...
    <div class="space-x-3 transition text-primary-500">
      ...
      <a v-if="appConfig.socials?.npm" target="_blank" :href="`https://www.npmjs.com/~${appConfig.socials?.npm}`" title="npm" class="dark:text-primary-100 hover:text-primary-700 dark:hover:text-primary-300"><Icon name="fa-brands:npm" class="w-5 h-5" /></a>
      <a v-if="appConfig.socials?.github" target="_blank" :href="`https://github.com/${appConfig.socials?.github}`" title="GitHub" class="dark:text-primary-100 hover:text-primary-700 dark:hover:text-primary-300"><Icon name="fa-brands:github" class="w-5 h-5" /></a>
