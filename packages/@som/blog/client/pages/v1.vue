<template>
  <div class="container mx-auto">
    ...
    <div
      class="hidden dark:flex dark:justify-between min-h-[calc(100vh-54px)] py-6 container max-w-[1160px] mx-auto"
    >
      <div
        class="swiper-button-prev w-6 text-xl sm:w-20 sm:text-7xl hover:animate-pulse hover:bg-white hover:bg-opacity-20 cursor-pointer text-white flex justify-center items-center"
        @click="prev"
      >
        ...
        <div class="swiper-wrapper">
          ...
          >
            <nuxt-link
              ...
              :key="item.path"
              :to="item.path"
              class="bg-black border border-solid border-accents-200 rounded-lg shadow-sm hover:border-white transition-colors"
            >
      ...
      <div
        class="swiper-button-next w-6 hover:animate-pulse hover:bg-white hover:bg-opacity-20 cursor-pointer text-white sm:w-20 sm:text-7xl flex justify-center items-center"
        @click="next"
      >
