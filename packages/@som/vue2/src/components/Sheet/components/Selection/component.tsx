...
export const Selection = defineComponent({
  ...
  render() {
    return this.flag ? <div ref="dom" style={this.styleObject} class="absolute ring-2 ring-offset-0 ring-blue-600 pointer-events-none bg-gray-900 bg-opacity-10"></div> : undefined
  }
})
